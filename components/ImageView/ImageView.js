...
const IMAGE_SPEED_FOR_CLOSE = 0.1; // was 1.1
...
export default class ImageView extends Component<PropsType, StateType> {
    ...
    constructor(props: PropsType) {
        ...
        this.modelBackgroundOpacity = new Animated.Value(0);
    ...
    componentWillReceiveProps(nextProps: PropsType) {
        ...
        if (
            ...
            this.modelBackgroundOpacity.setValue(0);
    ...
    onGestureMove(event: NativeEventType, gestureState: GestureState) {
        ...
        if (
            ...
            this.imageTranslateValue.y.setValue(y + dy);
            this.modelBackgroundOpacity.setValue(
    ...
    onGestureRelease(event: NativeEventType, gestureState: GestureState) {
        ...
        const {_value: modelBackgroundOpacity} = this.modelBackgroundOpacity;
        ...
        Animated.parallel(
            [
                modelBackgroundOpacity > 0
                    ? Animated.timing(this.modelBackgroundOpacity, {
                          toValue: 0,
                          duration: 100,
                      })
                    : null,
        ...
        // Close modal with animation if image not scaled and high horizontal gesture speed
        if (
            scale === imageInitialScale &&
            Math.abs(vx) >= IMAGE_SPEED_FOR_CLOSE
        ) {
            Animated.timing(this.imageTranslateValue.x, {
                toValue: x + 400 * vx,
                duration: 150,
    ...
    render(): Node {
        ...
        const animatedBackgroundColor = this.modelBackgroundOpacity.interpolate(
            {
                inputRange: [0, 1],
